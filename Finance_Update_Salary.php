				...
				<div class="col-md-10">
					...
					<div class="tab-content">
						<div class="tab-pane mt-4 show active">
							<form method="post" action="Finance_Update_Salary.php">
								<div class="row">
									<div class="col-md-12">
										<div class="input-group mb-3">
											...
											<div class="input-group-append">
                                                    ...
                                                    <a class="btn btn-secondary" href="Finance_Update_Salary.php"> Refresh </a>
											</div>
										</div>
									</div>
								</div>
											...
											?>
                                            			<tbody>
															<tr class="<?php echo $bg_color; ?>">
                                                                ...
                                                                <form action="Finance_Update_Salary_View1.php" method="post">

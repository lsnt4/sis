...
$resources = $resourceLoad->loadAllResources_date($_GET['fromDate'],$_GET['toDate']);
...
$pdf->Cell(50,15,$_GET['fromDate'].' to '.$_GET['toDate'].'',0,1);
$pdf->Cell(195 ,5,'',0,0);
$pdf->Cell(50 ,5,'Resource Date Log',0,1);

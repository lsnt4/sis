...
if(isset($_POST["report"])){
	...
	if($status == "All"){
		...
		$sql = "select * from expenses where payment_method = '$status'";
	}
		
		$result = $conn->query($sql);
if($result->num_rows == 0){
			set_error_msg("<strong>Oops!</strong> No ".$status." Expenses available!...");
			header("Location: Finance_Expense_Report.php");
}
$pdf = new PDF('P','mm','Letter');
$pdf->AliasNbPages();
$pdf->SetTitle("Success Internation School - ".ucfirst($status)." Expense History");
$pdf->AddPage();
...
$pdf->Cell(100,15,ucfirst($status).' Expenses',0,1);
$pdf->Cell(195 ,5,'',0,1);
$pdf->Cell(195 ,5,'',0,1);

				...
				<div class="col-md-10">
					...
					<div class="tab-content">
						<div class="tab-pane mt-4 show active">
							<form method="post" action="Finance_Download_Salary.php">
								<div class="row">
									<div class="col-md-12">
										<div class="input-group mb-3">
											...
											<div class="input-group-append">
                                                    ...
                                                    <a class="btn btn-secondary" href="Finance_Download_Salary.php"> Refresh </a>
											</div>
										</div>
									</div>
								</div>
                                            ...
                                            <?php
												if(isset($_POST["search"])){
													...
													if(empty($s_text)){
														...
														$sql_delete = "select * from payroll";
													}else{
														$sql_delete = "select * from payroll where ".$search." like '%".$s_text."%'";
													}
											...
											?>
                                            			<tbody>
															<tr class="<?php echo $bg_color; ?>">
                                                                ...
                                                                <form action="Finance_Download_Salary_View.php" method="post">
                                                                	<div class="btn-group" role="group" aria-label="Basic example">
                                                               		<input type="hidden" value="<?php echo $row["id"]; ?>" name="pay_id">
                                                                	<input type="submit" value=" Download " name="download" class="btn btn-link">
																	</div>
                                                        		</form>
                                                                </th>
															</tr>

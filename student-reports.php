...
<?php include_once 'staff-footer.php'; ?>							<a href="staff-add.php" class="nav-item nav-link disabled">Add</a>
							<a href="staff-attendance.php" class="nav-item nav-link disabled">Search</a>

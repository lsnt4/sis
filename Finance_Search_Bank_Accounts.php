...
if(isset($_POST["update"])){
		...
		if($result_check->num_rows>0 && $result->num_rows>0){
			...
			header("Location: Finance_Search_Bank_Accounts.php");
				...
				<div class="col-md-10">
					<nav>
						<div class="nav nav-tabs" id="nav-tab" role="tablist">
							...
							<a class="nav-item nav-link active"><strong> Search Bank Account 
                            <?php 
							if($row_tot_com > 0){
					...
					<div class="tab-content">
						<div class="tab-pane mt-4 show active">
							<form method="post" action="Finance_Search_Bank_Accounts.php">
								<div class="row">
									<div class="col-md-12">
										<div class="input-group mb-3">
											...
											<div class="input-group-append">
                                                    ...
                                                    <a class="btn btn-secondary" href="Finance_Search_Bank_Accounts.php"> Refresh </a>
											</div>
										</div>
										</div>
									</div>
									...
									<div class="col-md-12">
											...
											?>
                                            			<tbody>
                                                            ...
                                                            <form action="Finance_Search_Bank_Accounts.php" method="post" onSubmit="">
                                                                ...
                                                                <div class="input-group mb-2 mr-sm-2">
    																...
    																<input type="number" min="0" class="form-control" value="<?php echo $row["account_no"]; ?>" name="ano" placeholder=" Account Number " required>
  																</div>
                                                                </td>
                                                                <td> 
                                                                <div class="input-group mb-2 mr-sm-2">
    																...
    																<input type="text" min="0" class="form-control" value="<?php echo $row["bankname"]; ?>" name="bank_name" placeholder=" Bank Name " required>
  																</div>
                                                                </td>
                                                                <td> 
                                                                <div class="input-group mb-2 mr-sm-2">
    																...
    																<input type="text" min="0" class="form-control" value="<?php echo $row["branch"]; ?>" name="branch_name" placeholder=" Branch Name " required>
  																</div>
                                                                </td>

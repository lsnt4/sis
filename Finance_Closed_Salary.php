				...
				<div class="col-md-10">
					...
					<div class="tab-content">
						<div class="tab-pane mt-4 show active">
							<form method="post" action="Finance_Closed_Salary.php">
								<div class="row">
									<div class="col-md-12">
										<div class="input-group mb-3">
											...
											<div class="input-group-append">
                                                    ...
                                                    <a class="btn btn-secondary" href="Finance_Closed_Salary.php"> Refresh </a>
											</div>
										</div>
									</div>
								</div>
                                            ...
                                            <?php
												if(isset($_POST["search"])){
													...
													if(empty($s_text)){
														...
														$sql_delete = "select * from payroll where status='closed'";
													}else{
														$sql_delete = "select * from payroll where ".$search." like '%".$s_text."%' and status='closed'";
													}
											...
											?>
                                            			<tbody>
															<tr class="<?php echo $bg_color; ?>">
                                                                ...
                                                                <form action="Finance_Closed_Salary_View.php" method="post">
                                                                	<div class="btn-group" role="group" aria-label="Basic example">
                                                               		<input type="hidden" value="<?php echo $row["id"]; ?>" name="pay_id">
                                                                	<input type="submit" value=" Move Pending " name="movepending" class="btn btn-info">
																	</div>
                                                        		</form>
                                                                </th>
															</tr>

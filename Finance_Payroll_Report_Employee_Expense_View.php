...
$pdf->AliasNbPages();
$pdf->SetTitle("Success Internation School - Payroll Employee Deductions");
$pdf->AddPage();
...
$pdf->Cell(100,15,'Payroll Employee Deductions',0,1);
$pdf->Cell(195 ,5,'',0,1);
$pdf->Cell(195 ,5,'',0,1);
...
$pdf->Cell(30, 5,'Year',0,0);
$pdf->Cell(30, 5,'Employee EPF',0,0);
$pdf->Cell(30, 5,'Employee Tax',0,0);
...
while($row = $result->fetch_assoc()){
	...
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(5, 5, $i, 0, 0);
	$pdf->Cell(35, 5, $row["staff_id"], 0, 0);
	$pdf->Cell(25, 5, $row["month"], 0, 0);
	$pdf->Cell(30, 5, $row["year"], 0, 0);
	$pdf->Cell(30, 5, number_format((float)$row["employee_epf"], 2, '.', ''), 0, 0);
	$pdf->Cell(30, 5, number_format((float)$row["employee_tax"], 2, '.', ''), 0, 0);
	$pdf->Cell(20, 5, number_format((float)$row["net_sal"], 2, '.', ''), 0, 0);
	$pdf->Cell(30, 5, $row["status"], 0, 1);
	$tot1 = $tot1 + $row["employee_epf"];
	$tot2 = $tot2 + $row["employee_tax"];
	$tot3 = $tot3 + $row["net_sal"];
	$i++;
}

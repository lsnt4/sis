	...
	include_once 'DB_Connection.php';
		...
		if(isset($_POST["verify_data"])){
			...
			$status = "closed";
				...
				$sql = "update payroll set verified_by='$added_by',verified_date='$added_date',status='$status' where id='$payid'";
				
						if($conn->query($sql) == true){
							  		set_success_msg("<strong>Success!</strong> PAY".$payid." payroll has been successfully verified!");
									header("Location: Finance_Verify_Salary.php");
							  }
						  else{
...
<div class="row">
<form action="Finance_Verify_Salary_View.php" method="post" class="form" role="form" autocomplete="off">
  					...
  					<div class="card">
                       ...
                       <div class="card-header">
                        ...
                        <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        <a href="Finance_Verify_Salary.php" class="btn btn-danger"> Cancel </a>
                                        <input type="submit" name="verify_data" class="btn btn-secondary" value="Verify">
                                    </div>
                                </div>
                        </div>
                    </div>

				...
				<div class="col-md-10">                    
                    <nav>
						<div class="nav nav-tabs" id="nav-tab" role="tablist">
                        	<a class="nav-item nav-link active"><strong> Income Dashboard </strong></a>
							<a href="Finance_Add_Incomes.php" class="nav-item nav-link"><strong> Add Incomes </strong></a>
                            <?php
                            $sql_up = "SELECT * FROM incomes where catogory not in ('Student','Library Management','Exam Management','Course Management')";

				...
				<div class="col-md-10">
					<nav>
						<div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link active"><strong> Rejected Leaves 
                            <?php if($row_del>0){
									echo "<span class='badge badge-success badge-pill'> ".$row_del." <span>";
								  } 
							?>
                            </strong></a>
						</div>
					...
					<div class="tab-content">
						<div class="tab-pane mt-4 show active">
							<form method="post" action="Finance_Rejected_Leave_Request.php">
								<div class="row">
									<div class="col-md-12">
										<div class="input-group mb-3">
											...
											<div class="input-group-append">
                                                    ...
                                                    <a class="btn btn-secondary" href="Finance_Rejected_Leave_Request.php"> Refresh </a>
											</div>
										</div>
									</div>
								</div>
                                            ...
                                            <?php
												if(isset($_POST["search"])){
													...
													if(empty($s_text)){
														...
														$sql_delete = "select * from leave_request where status='rejected'";
													}else{
														$sql_delete = "select * from leave_request where status='rejected' and ".$search." like '%".$s_text."%'";
													}
                                            			...
                                            			<tbody>
                                                            ...
                                                            <form action="Finance_Rejected_Leave_Request.php" method="post" onSubmit="return confirm('WARNING!\n\n1. Accidentally move pending of records cannot backup from the system.\n2. There is no way to undo this action.\n\nDo you still really want to move pending the leave LEA<?php echo $row["id"]; ?>?');">
                                                                ...
                                                                <td>
                                                                	...
                                                                	<input type="submit" value=" Move Pending " name="move_pending" class="btn btn-outline-danger">
                                                                </td>
                                                            </form>
															</tr>
														</tbody>

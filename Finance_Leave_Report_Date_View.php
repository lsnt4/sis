...
if(isset($_POST["report"])){
	...
	if($startdate < $enddate){
		$sql = "select * from leave_request where added_date between '$startdate' and '$enddate'";
		$result = $conn->query($sql);
if($result->num_rows == 0){
			set_error_msg("<strong>Oops!</strong> No Leave Request available between '$startdate' and '$enddate'!...");
			header("Location: Finance_Leave_Report.php");
}
$pdf = new PDF('P','mm','Letter');
$pdf->AliasNbPages();
$pdf->SetTitle("Success Internation School - Leave History from $startdate to $enddate");
$pdf->AddPage();
...
$pdf->Cell(100,15,'Leave ('.$startdate.' - '.$enddate.')',0,1);
$pdf->Cell(195 ,5,'',0,1);
$pdf->Cell(195 ,5,'',0,1);

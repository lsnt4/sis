...
if(isset($_POST["report"])){
	...
	if($startdate < $enddate){
		$sql = "select * from payroll where added_date between '$startdate' and '$enddate'";
		$result = $conn->query($sql);
if($result->num_rows == 0){
			set_error_msg("<strong>Oops!</strong> No Payrolls available between '$startdate' and '$enddate'!...");
			header("Location: Finance_Payroll_Report.php");
}
$pdf = new PDF('P','mm','Letter');
$pdf->AliasNbPages();
$pdf->SetTitle("Success Internation School - Payroll History from $startdate to $enddate");
$pdf->AddPage();
...
$pdf->Cell(100,15,'Payroll ('.$startdate.' - '.$enddate.')',0,1);
$pdf->Cell(195 ,5,'',0,1);
$pdf->Cell(195 ,5,'',0,1);

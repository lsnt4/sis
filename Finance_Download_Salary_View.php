			...
			$status = "pending";
				...
				$sql = "";
						...
						if($conn->query($sql) == true){
							  		set_success_msg("<strong>Success!</strong> PAY".$payid." payroll has been successfully deleted!");
									header("Location: Finance_Download_Salary.php");
							  }
						  else{
				...
				<div class="col-md-10">                    
                    <nav>
						<div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link active"><strong> Download Payroll 
                            <?php if($row_tot>0){
...
<div class="row">
<form action="Finance_Pay_Slip_View.php" method="post" class="form" role="form" autocomplete="off">
  					...
  					<div class="card">
                       ...
                       <div class="card-header">
                        ...
                        <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        <a href="Finance_Download_Salary.php" class="btn btn-danger"> Cancel </a>
                                        <input type="submit" name="download_data" class="btn btn-success" value="Download">
                                    </div>
                                </div>
                        </div>
                    </div>

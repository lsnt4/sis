<?php 
	...
	include_once 'DB_Connection.php';
		...
		if(isset($_POST["update"])){
			...
			$sql_check_pay = "select * from payroll where staff_id='$userid' and month='$month_pay' and year='$year_pay' and payment_method='$method'";
			...
			if($result_check_pay->num_rows>0){
				...
				$sql = "update payroll set staff_id = '$userid',
				month = '$month_pay',
				year = '$year_pay',
				employee_epf = '$empepf',
				employee_tax = '$emptax',
				...
				where id = '$pay_id'";
						...
						if($conn->query($sql) == true){
							  		set_success_msg("<strong>Success!</strong> PAY".$pay_id." payroll has been successfully updated!");
									header("Location: Finance_Update_Salary.php");
							  }
						  else{
...
function getMonthNo($m){
    if($m=="January"){
        ...
        return 12;
			...
			$sql_check_pay = "select * from payroll where staff_id='$user_id' and month='$month' and year='$year' and payment_method='$method'";
			$result_check_pay = $conn->query($sql_check_pay);
...
<div class="row">
<form action="Finance_Update_Salary_View2.php" method="post" class="form" role="form" autocomplete="off">
                        ...
                        <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-5">
                                        ...
                                        <input class="form-control" name="userid" type="text" value="<?php echo $user_id; ?>" readonly>
                                    </div>
                                    <div class="col-lg-3">
  					...
  					<div class="card">
                       ...
                       <div class="card-header">
                        ...
                        <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        <a href="Finance_Update_Salary.php" class="btn btn-danger"> Cancel </a>
                                        <input type="submit" name="update" class="btn btn-success" value=" Update PAY<?php echo $payid; ?> ">
                                    </div>
                                </div>
                        </div>
                    </div>

...
if(isset($_POST["report"])){
		$sql = "select * from bank_accounts where userid != 0";
		$result = $conn->query($sql);
if($result->num_rows == 0){
			set_error_msg("<strong>Oops!</strong> No Bank Accounts available!...");
			header("Location: Finance_Bank_Accounts_Report.php");
}
$pdf = new PDF('P','mm','Letter');
$pdf->AliasNbPages();
$pdf->SetTitle("Success Internation School - Bank Accounts - Employee ");
$pdf->AddPage();
...
$pdf->Cell(100,15,'Bank Accounts - Employee',0,1);
$pdf->Cell(195 ,5,'',0,1);
$pdf->Cell(195 ,5,'',0,1);

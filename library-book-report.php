...
if($result->num_rows == 0){
			set_error_msg("<strong>Oops!</strong> No  Books available!...");
			header("Location: library-book-report.php");
}
$pdf = new PDF('P','mm','Letter');
$pdf->AliasNbPages();
$pdf->SetTitle("Success Internation School -  Book Details");
$pdf->AddPage();
...
$pdf->Cell(100,15,' Book Details ',0,1);
$pdf->Cell(195 ,5,'',0,1);
$pdf->Cell(195 ,5,'',0,1);
...
$pdf->Cell(5, 5,'#',0,0);
$pdf->Cell(25, 5,'Book ID',0,0);
$pdf->Cell(40, 5,'Book Name',0,0);
$pdf->Cell(50, 5,'Authour Name',0,0);
$pdf->Cell(20, 5,'ISBN',0,0);
$pdf->Cell(20, 5,'Year',0,0);
$pdf->Cell(30, 5,'Copies',0,1);
$i = 1;
while($row = $result->fetch_assoc()){

	$pdf->SetFont('Arial','',9);
	$pdf->Cell(5, 5, $i, 0, 0);
	$pdf->Cell(25, 5, $row["BID"], 0, 0);
	$pdf->Cell(40, 5, $row["fname"], 0, 0);
	$pdf->Cell(50, 5, $row["Aname"], 0, 0);
	$pdf->Cell(20, 5, $row["ISBN"], 0, 0);
	$pdf->Cell(20, 5, $row["book_year"], 0, 0);
	$pdf->Cell(30, 5, $row["copies"], 0, 1);
	$i++;
}

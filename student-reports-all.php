...
$students = $studentManager->retrieveStudentData();
...
$pdf->AliasNbPages();
$pdf->SetTitle("Success Internation School -Student Enrollment Details");
$pdf->AddPage();
...
$pdf->Cell(50,15,'Student Database',0,1);
...
foreach ($students as $student) {
    ...
    $pdf->Cell(35, 5, $student['fname'], 0, 0);
    $pdf->Cell(50, 5, $student['email'], 0, 0);
    $pdf->Cell(15, 5, $student['grade'], 0, 0);
    $pdf->Cell(30, 5, $student['mobile_no'], 0, 0);
    $pdf->Cell(25, 5, $student['dob'], 0, 0);

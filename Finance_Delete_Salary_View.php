				...
				<div class="col-md-10">                    
                    <nav>
						<div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link active"><strong> Delete Payroll 
                            <?php if($row_tot>0){
...
<div class="row">
<form action="Finance_Delete_Salary_View.php" method="post" class="form" role="form" autocomplete="off">
  					...
  					<div class="card">
                       ...
                       <div class="card-header">
                        ...
                        <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        <a href="Finance_Delete_Salary.php" class="btn btn-danger"> Cancel </a>

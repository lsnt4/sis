...
// Company
function addSociete( $nom,$dep,$adresse )
{
	$x1 = 10;
	$y1 = 8;
	...
	$this->SetXY( $x1, $y1 + 4 );
	$length = $this->GetStringWidth( $dep );
	$this->Cell( $length, 3, $dep);
	$this->SetXY( $x1, $y1 + 8 );
...
function fact_dev($libelle,$dta,$num)
{
    $r1  = $this->w - 80;
    $r2  = $r1 + 68;
    $y1  = 6;
...
function addDate( $date )
{
	...
	$this->SetFont( "Arial", "B", 10);
	$this->Cell(10,5, "PRINT DATE", 0, 0, "C");
...
// Mode of payment
function addReglement( $mode,$acc )
{
	$r1  = 10;
	$r2  = $r1 + 60;
	$y1  = 80;
	...
	$this->SetFont( "Arial", "", 10);
	$this->Cell(10,5,$mode." - ".$acc." Account ", 0,0, "C");
}
...
function addEcheance( $date )
{
	...
	$this->SetXY( $r1 + ($r2 - $r1)/2 - 5 , $y1+1 );
	$this->SetFont( "Arial", "B", 10);
	$this->Cell(10,4, "PAYROLL ID", 0, 0, "C");
	$this->SetXY( $r1 + ($r2-$r1)/2 - 5 , $y1 + 5 );
	$this->SetFont( "Arial", "", 10);
	$this->Cell(10,5,"PAY - ".$date, 0,0, "C");
}

// VAT number
function addNumTVA($bank,$date)
{
	$this->SetFont( "Arial", "B", 10);
	$r1  = $this->w - 80;
	$r2  = $r1 + 70;
	...
	$this->Cell(40, 4, "BANK ACCOUNT DETAILS", '', '', "C");
	$this->SetFont( "Arial", "", 10);
	$this->SetXY( $r1 + 16 , $y1+5 );
	$this->Cell(40, 5, $bank." - ".$date, '', '', "C");
}

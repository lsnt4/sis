...
if($result->num_rows == 0){
			set_error_msg("<strong>Oops!</strong> No Leaves available!...");
			header("Location: Finance_Leave_Report.php");
}
$pdf = new PDF('P','mm','Letter');
$pdf->AliasNbPages();
$pdf->SetTitle("Success Internation School -  Leave Balance");
$pdf->AddPage();
...
$pdf->Cell(100,15,' Leaves Balance ',0,1);
$pdf->Cell(195 ,5,'',0,1);
$pdf->Cell(195 ,5,'',0,1);
...
$pdf->Cell(30, 5,'Casual Leaves',0,0);
$pdf->Cell(30, 5,'Vacation Leaves',0,0);
$pdf->Cell(30, 5,'Sick Leaves',0,1);
$i = 1;
$tot1 = 0;
$tot2 = 0;
$tot3 = 0;
while($row = $result->fetch_assoc()){
	...
	$pdf->Cell(30, 5, $row["casual"], 0, 0);
	$pdf->Cell(30, 5, $row["vacation"], 0, 0);
	$pdf->Cell(30, 5, $row["sick"], 0, 1);
	$tot1 = $tot1 + $row["casual"];
	$tot2 = $tot2 + $row["vacation"];
	$tot3 = $tot3 + $row["sick"];
	$i++;
}
...
$pdf->SetFont('Arial','B',9);
	...
	$pdf->Cell(30, 5, $tot1, 0, 0);
	$pdf->Cell(30, 5, $tot2, 0, 0);
	$pdf->Cell(30, 5, $tot3, 0, 1);
$pdf->Close();
$pdf->Output();
}
?>
...
$employees = $staff_manager->get_attendances_by_date_range($start_date, $end_date);
...
$pdf->AliasNbPages();
$pdf->SetTitle("Success Internation School - Attendance History Report");
$pdf->AddPage();
...
$pdf->Cell(50,15,'Attendance History',0,1);
...
$pdf->Cell(45, 5,'First Name',0,0);
$pdf->Cell(45, 5,'Last Name',0,0);
$pdf->Cell(45, 5,'Date',0,0);
$pdf->Cell(65, 5,'Time',0,1);
...
foreach ($employees as $employee) {
	...
	$pdf->Cell(45, 5, $employee['fname'], 0, 0);
	$pdf->Cell(45, 5, $employee['lname'], 0, 0);
	$pdf->Cell(45, 5, $employee['date'], 0, 0);
	$pdf->Cell(65, 5, $employee['time'], 0, 1);
}

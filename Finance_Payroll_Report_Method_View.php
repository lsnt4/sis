...
if(isset($_POST["report"])){
	...
	if($status == "All"){
		...
		$sql = "select * from payroll where payment_method = '$status'";
	}
		
		$result = $conn->query($sql);
if($result->num_rows == 0){
			set_error_msg("<strong>Oops!</strong> No ".$status." Payrolls available!...");
			header("Location: Finance_Payroll_Report.php");
}
$pdf = new PDF('P','mm','Letter');
$pdf->AliasNbPages();
$pdf->SetTitle("Success Internation School - ".ucfirst($status)." Payroll History");
$pdf->AddPage();
...
$pdf->Cell(100,15,ucfirst($status).' Payrolls',0,1);
$pdf->Cell(195 ,5,'',0,1);
$pdf->Cell(195 ,5,'',0,1);

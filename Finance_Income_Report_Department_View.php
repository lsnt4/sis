...
if(isset($_POST["report"])){
	...
	if($status == "all"){
		...
		$sql = "select * from incomes where catogory = '$status'";
	}
...
$pdf->Cell(30 ,5,'',0,0);
$pdf->Cell(35 ,5,'',0,1);
$pdf->Cell(0 ,15,'_______________________________________________________________________________________________________',0,1);
